...
<!-- Mirrored from htmldemo.net/khobor/khobor/post-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Feb 2023 08:50:10 GMT -->
    ...
    <div class="post-header-section section mt-30 mb-30">
        <div class="container">
            <div class="row row-1">
                ...
                <!-- Page Banner Start -->
                <div class="col-12">
                    <div class="post-header" style="background-image: url(assets/img/bg/page-banner-fashion.jpg)">
                        
                        <!-- Title -->
                        <h3 class="title">The top 7 collections of New York fashion week.</h3>
                        
                        <!-- Meta -->
                        <div class="meta fix">
                            <a href="#" class="meta-item category fashion">fashion</a>
                            <a href="#" class="meta-item author"><img src="assets/img/post/post-author-1.jpg" alt="post author">Sathi Bhuiyan</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-12 mb-50">
                                    ...
                                    <div class="single-post">
                                        <div class="post-wrap">
                                            ...
                                            <div class="content">
                                                ...
                                                <p><img class="float-end" src="img/post/post-153.jpg" alt="post">
                                                ...
                                                <img src="assets/img/post/post-132.jpg" alt="post">
                                                <div class="row">
                                                ...
                                                <p>If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators. <br>
                    ...
                    <div class="post-author fix mb-50">
                        ...
                        <div class="image float-start"><img src="assets/img/post/post-author-1.jpg" alt="post-author"></div>
                                ...
                                <div class="slick-slide">
                                    ...
                                    <div class="post post-overlay hero-post">
                                        <div class="post-wrap">
                                            ...
                                            <!-- Image -->
                                            <div class="image"><img src="assets/img/post/post-135.jpg" alt="post"></div>
